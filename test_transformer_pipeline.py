#!/usr/bin/env python3
"""
Test script for the Transformer Pipeline
Demonstrates advanced BERT/RoBERTa models for fake text detection
"""
...
def main():
    ...
    try:
        print("\n📊 PHASE 2: ADVANCED TRANSFORMER MODELS")
        print("=" * 60)
        ...
        if submission is not None:
            ...
            results_summary = {
                'pipeline_type': 'transformer_advanced',
            ...
            print(f"\n💾 Results summary saved to transformer_results.json")
            
    except Exception as e:
        print(f"\n❌ TRANSFORMER PIPELINE FAILED: {e}")
        import traceback
        traceback.print_exc()
